<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:74:"G:\wamp64\www\HManagement\public/../application/index\view\grade\edit.html";i:1533657379;s:65:"G:\wamp64\www\HManagement\application\index\view\public\base.html";i:1533718727;s:65:"G:\wamp64\www\HManagement\application\index\view\public\meta.html";i:1532964505;s:67:"G:\wamp64\www\HManagement\application\index\view\public\footer.html";i:1532964423;}*/ ?>
<!--_meta 作为公共模版分离出去-->
<!DOCTYPE HTML>
<html>
<head>
...
<article class="cl pd-20">
    ...
    <form action="" method="post" class="form form-horizontal" id="form-grade-edit">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" autocomplete="off" value="<?php echo $grade_info['length']; ?>" placeholder="学制"
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" placeholder="学费" name="price" id="price"
                       value="<?php echo $grade_info['price']; ?>">
            </div>
        </div>
