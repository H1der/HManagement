<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:76:"G:\wamp64\www\HManagement\public/../application/index\view\student\edit.html";i:1533886296;s:65:"G:\wamp64\www\HManagement\application\index\view\public\base.html";i:1533718727;s:65:"G:\wamp64\www\HManagement\application\index\view\public\meta.html";i:1532964505;s:67:"G:\wamp64\www\HManagement\application\index\view\public\footer.html";i:1532964423;}*/ ?>
<!--_meta 作为公共模版分离出去-->
<!DOCTYPE HTML>
<html>
<head>
    ...
    <form action="" method="post" class="form form-horizontal" id="form-student-edit">
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                ...
                <input type="text" class="input-text" value="<?php echo $student_info['name']; ?>" placeholder=""
                       id="name" name="name">
            </div>
        </div>
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" placeholder="年龄" name="age" id="age"
                       value="<?php echo $student_info['age']; ?>">
            </div>
        </div>
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9"> <span class="select-box" style="width:150px;">
				<select class="select" name="grade_id" size="1">
					<?php if (is_array($gradeList) || $gradeList instanceof \think\Collection || $gradeList instanceof \think\Paginator): $i = 0;
                        $__LIST__ = $gradeList;
